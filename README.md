...
[![Version](https://img.shields.io/badge/version-4.2.7-blue.svg)](https://github.com/saladday/cc-switch-cli/releases)
...
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.7-darwin-universal.tar.gz

# Extract
tar -xzf cc-switch-cli-v4.2.7-darwin-universal.tar.gz
...
```bash
# Download
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.7-linux-x64-musl.tar.gz

# Extract
tar -xzf cc-switch-cli-v4.2.7-linux-x64-musl.tar.gz
...
curl -LO https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.7-linux-arm64-musl.tar.gz
tar -xzf cc-switch-cli-v4.2.7-linux-arm64-musl.tar.gz
chmod +x cc-switch
sudo mv cc-switch /usr/local/bin/
```
...
# https://github.com/saladday/cc-switch-cli/releases/latest/download/cc-switch-cli-v4.2.7-windows-x64.zip
